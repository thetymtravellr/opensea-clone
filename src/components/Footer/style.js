...
export const FooterStyled = styled('footer')(({ theme }) => ({
    background: isDarkMode(theme) ? "rgb(4, 17, 29)":  theme.palette.primary.dark,
...
export const SubscribeFormInput = styled(FormControl)(({ theme }) => ({
    ...
    marginRight: '12px',
    input: {
    background: theme.palette.mode === 'light' ? "#fff" : "none",
    color: theme.palette.mode === 'light' ? "rgb(4, 17, 29)" : "#fff",
    width: '100%',
    borderRadius: '12px',
...
export const ColumnLinks = styled(Link)(({theme})=>{
    return (`
