...
const artCollection = () => {
    return (
        <>
            <Header bg={true} />
            <Category
                text={<>An online community of makers, developers, and traders is pushing the art world into new territory. It all started with CryptoPunks, a set of 10,000 randomly generated punks that proved demand for the digital ownership of non-physical items and collectibles in 2017</>}
                data={data}
                title="Explore Art"
                banner="https://i.seadn.io/gae/kVVevhk9BBE5BSuIoQfkH5_5FVsPTJCR34wpVBf1ACURh9dfNaybChPgiicte10yb6SYVp5iMQNXaQrOnHXmRiiOtVxUzYJR3M1I?auto=format&w=1920" />
        </>
    )
}
