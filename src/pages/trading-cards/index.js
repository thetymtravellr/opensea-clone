...
const artCollection = () => {
    return (
        <>
            <Header bg={true} />
            <Category text={<>Collect, trade and sell in-game items, plus explore a wide range of collectible trading cards.</>} data={data} title="Explore Trading Card NFTs" banner="https://i.seadn.io/gae/8VGubP7xBfRaeO_EslP8yXVyI0sMyfysOnt1NfbBnY6O7djIVrMeCXHZ8Y2hDqu6DEEc7UZqf87CcxxEOlgVDcVG1TTT72KLpi4_G9M?auto=format&w=828"/>
        </>
    )
}
