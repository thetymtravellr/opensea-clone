...
const artCollection = () => {
    return (
        <>
            <Header bg={true} />
            <Category text={<>Explore and own collectibles from some of the biggest sports teams and brands in the world.</>} data={data} title="Explore Sport NFTs" banner="https://i.seadn.io/gae/F97uNjhmvg4r91VD4zQ7TZrDwtwjqfbgygv64zrDqKsuITEX9wROYgHSsihHaqCOjhOmNf-IR91v2IJKqQFGEB_1GsSxOi6V0XDl2g?auto=format&w=828"/>
        </>
    )
}
