...
const solanaCollection = () => {
    return (
        <>
            <Header bg={true} />
            <Category
                text={<>Explore, buy and sell popular Solana NFTs on OpenSea and enjoy low gas fees and fast transaction speeds. {" "}
                    <Link href="https://opensea.io/explore-solana" style={{ display: 'inline' }}>
                        Learn more about OpenSea's Solana launchpad.
                    </Link></>}
                data={data}
                title="Explore Solana NFTs"
                banner="https://static.opensea.io/solana/explore-solana.png" />
        </>
    )
}
