...
const artCollection = () => {
    return (
        <>
            <Header bg={true} />
            <Category text={<>Photographers are taking the NFT world by storm, and we've got a selection of breathtaking collections from a growing and increasingly global community of creators right here on OpenSea.</>} data={data} title="Explore Photography" banner="https://i.seadn.io/gae/g6IAEmQm0J8J2ZoG0wLS04HEkVC7OvxNON5TvBZ4UR0Jm6LfIH4QwJNLWSnJsnabTnvarLUhpfRw_l-lMSBu6R0ymspZXNnT11YtXw?auto=format&w=828" />
        </>
    )
}
