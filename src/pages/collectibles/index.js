...
const artCollection = () => {
    return (
        <>
            <Header bg={true} />
            <Category text={<>The way we value internet-native items is changing with the development of blockchain technology. Kittens, punks, and memes are now trading digital wallets for cryptocurrencies, and the online collectibles market is taking shape before our eyes.</>} data={data} title="Explore Collectibles" banner="https://i.seadn.io/gae/l8oHCZk1C7EsY4Up-84SzLRwBGrRCDh7Z5k8WDnWIU1749AFyGY-ULYvZ952vKUhOydLrbdZHwjr50ARrqE2kYPEMqwHhg72d1JthQ?auto=format&w=1920"/>
        </>
    )
}
