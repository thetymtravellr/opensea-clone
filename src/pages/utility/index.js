...
const artCollection = () => {
    return (
        <>
            <Header bg={true} />
            <Category text={<>From redeemable rewards to membership NFTs, explore a wide range of utility items that unlock access to special and unique benefits.</>} data={data} title="Explore Utility NFTs" banner="https://i.seadn.io/gae/Vw6MpADIga_ZwmXOmclK87L8ax6pI_DylBcn-69kcr1Uhgw5Ij2RvXJD2MFJ0VarfIGeoFZw7NvpGLePX3e2VMztvg7XCQDNo12dLQ?auto=format&w=828"/>
        </>
    )
}
